<template>
  <RedeemShell>
    <div class="text-center space-y-6">
      ...
      <div class="space-y-3">
        <h1
          class="text-[40px] leading-tight font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-sky-600 via-cyan-500 to-emerald-500 dark:from-sky-400 dark:via-cyan-400 dark:to-emerald-400 drop-shadow-sm animate-gradient-x"
        >
          {{ title }}
        </h1>
      </div>
