<template>
  <RedeemShell>
    <div class="text-center space-y-6">
      ...
      <div class="space-y-3">
        <h1 class="text-[40px] leading-tight font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-rose-500 via-orange-500 to-amber-400 dark:from-rose-400 dark:via-orange-400 dark:to-amber-300 drop-shadow-sm animate-gradient-x">
          小红书订单兑换
        </h1>
      </div>
    </div>
    ...
    <div class="relative group perspective-1000">
      <div class="absolute -inset-1 bg-gradient-to-r from-rose-500 via-orange-500 to-amber-400 rounded-[2rem] blur opacity-25 group-hover:opacity-50 transition duration-1000 group-hover:duration-200 animate-tilt"></div>
      <AppleCard
        variant="glass"
          ...
          <form @submit.prevent="handleRedeem" class="space-y-8">
            ...
            <div class="pt-2 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-300 fill-mode-backwards">
              <AppleButton
                ...
                variant="primary"
                size="lg"
                class="w-full h-[50px] text-[17px] font-medium shadow-lg shadow-rose-500/20 hover:shadow-orange-500/25 transition-all duration-300 hover:scale-[1.02] active:scale-[0.98]"
                :loading="isLoading"
                :disabled="isLoading"
              >
                {{ submitButtonLabel }}
          ...
          <div class="pt-6 border-t border-slate-200/70 dark:border-slate-700/50 space-y-3">
            ...
            <ul class="space-y-3 text-[14px] text-[#1d1d1f]/70 dark:text-white/70">
              <li class="flex items-start gap-3">
                <span class="h-1.5 w-1.5 rounded-full bg-[#f43f5e] mt-2 flex-shrink-0"></span>
                <RouterLink
